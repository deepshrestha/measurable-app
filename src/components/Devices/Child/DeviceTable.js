        ...
        Object.keys(tableObj.data).map(item => {
            if (typeof tableObj.data[item] === "object") {
                Object.values(data[item]).map((result, index) => {
                    let locationBuilder = result.location_builder ?? "";
                    ...
                    let template = `<tr data-device-number="${result.device_number}">
                                    ...
                                    <td>
                                    <span class="select-details" id="select-details_${result.device_number}"><a href="javascript:void(0);"><i class="fa fa-eye"></i></a></span>
                    ...
                    content += template;
                    /* return(
                        <tr key={index} data-device-number={result.device_number}>
                            <td>
                            <input type="checkbox" className="checkbox select-checkbox" 
                                    id={`${result.device_number}-checkbox`}
                                    onClick={onSelectCheckBox} />
                            </td>
                            <td>
                                <span><a href="#"><i className="fa fa-eye"></i></a></span>
                                <span><a href="#"><i className="fa fa-pencil-square-o"></i></a></span>
                                <span><a href="#"><i className="fa fa-trash-o"></i></a></span>
                            </td>
                            <td>{result.device_number}</td>
                            <td>{result.name}</td>
                            <td>{result.type}</td>
